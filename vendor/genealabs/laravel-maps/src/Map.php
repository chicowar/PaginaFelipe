...
class Map
{
    ...
    public $disableDefaultUI = true;                    // If set to TRUE will hide the default controls (ie. zoom, scale etc)
    ...
    public $disableStreetViewControl = true;                    // If set to TRUE will hide the Street View control
    ...
    public $geocodeCaching = true;                    // If set to TRUE will cache any geocode requests made when an address is used instead of a lat/long. Requires DB table to be created (see documentation)
